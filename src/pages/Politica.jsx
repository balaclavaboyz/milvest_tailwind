...
export default function Politica() {
    return (
        <>
            <div className="container flex flex-col mx-auto space-y-6 my-6 p-12">
                <div className="container space-y-3 mb-6">
                    ...
                    <p>
                        ...
                        Milvest respeitar a sua privacidade em relação a
                ...
                <div className="container space-y-6">
                    ...
                    <p>
                        ...
                        ou não deles, caso sejam usados ​​para fornecer um
                    ...
                    <p>
                        ...
                        desativação de cookies geralmente resultará na
                    ...
                    <ul>
                        <li>
                            ...
                            soluções de análise mais difundidas e confiáveis
                            ​​da Web, para nos ajudar a entender como você usa o
                            site e como podemos melhorar sua experiência. Esses
                            cookies podem rastrear itens como quanto tempo você
                            gasta no site e as páginas visitadas, para que
                    ...
                    <ul>
                        <li>
                            ...
                            rastrear itens como o tempo que você passa no site
                            ou as páginas visitadas, o que nos ajuda a entender
                            como podemos melhorar o site para você.
                        </li>
                        <li>
                            Periodicamente, testamos novos recursos e fazemos
                            alterações subtis na maneira como o site se
                            apresenta. Quando ainda estamos testando novos
                            recursos, esses cookies podem ser usados ​​para
                            garantir que você receba uma experiência consistente
                            enquanto estiver no site, enquanto entendemos quais
                        ...
                        <li>
                            ...
                            de nosso site realmente compram e, portanto, esse é
                            o tipo de dados que esses cookies rastrearão. Isso é
                            importante para você, pois significa que podemos
                    ...
                    <p>
                        ...
                        conteúdos e da informação que o Milvest oferece no site
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            racista, xenofóbica, ou casas de apostas online
                            (ex.:
                            <a href="https://ondeapostar.pt/review/betano/">
                                {" "}
                                Betano
                            </a>
                            ), jogos de sorte e azar, qualquer tipo de
                            pornografia ilegal, de apologia ao terrorismo ou
                            contra os direitos humanos;
                        </li>
                        <li>
                            C) Não causar danos aos sistemas físicos (hardwares)
                            e lógicos (softwares) do Milvest, de seus
                    ...
                    <p>
                        ...
                        <strong>Maio</strong>/<strong>2021</strong>.
                    </p>
                </div>
            </div>
        </>
